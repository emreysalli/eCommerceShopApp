      ...
      <div className="productTop">
        ...
        <div className="productTopRight">
            <div className="productInfoTop">
                <img src="https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/MV7N2_AV1?wid=2000&hei=2000&fmt=jpeg&qlt=95&.v=1551489684370" alt="" className="productInfoImg" />
        ...
        <form className="productForm">
            ...
            <div className="productFormRight">
                <div className="productUpload">
                    <img src="https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/MV7N2_AV1?wid=2000&hei=2000&fmt=jpeg&qlt=95&.v=1551489684370" alt="" className="productUploadImg" />
                    <label for="file">
                        <Publish/>
                    </label>
